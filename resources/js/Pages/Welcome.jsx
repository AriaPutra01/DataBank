...
export default function Welcome({ auth }) {
    return (
        <>
            ...
            />
            <div className="absolute overflow-hidden z-10 top-0 left-0 right-0 bottom-0 selection:bg-[#0041ab] dark:bg-gray-800/50 bg-center bg-cover selection:text-white">
                <header className="flex justify-around items-center gap-2 py-10">
                    <div className="hidden lg:flex lg:justify-center">
                        <svg
                            className="h-12 w-auto text-white lg:h-16 lg:text-white col-start-1"
                            viewBox="0 0 62 65"
                            fill="none"
                    ...
                    <nav className="-mx-3 flex col-start-3">
                        ...
                        <div class="mx-auto max-w-2xl">
                            <div class="hidden sm:mb-8 sm:flex sm:justify-center">
                                <div class="relative rounded-full px-3 py-1 text-sm leading-6 text-white ring-2 ring-gray-200 dark:ring-indigo-600 hover:ring-gray-100 dark:hover:ring-indigo-400">
                                    Solusi pengelolaan data yang cerdas untuk
                                    bisnis Anda.
                                </div>
                            </div>
                            <div class="text-center">
                                ...
                                <p class="hidden sm:block mt-6 px-6 sm:px-0 text-xl leading-8 text-blue-900 font-bold dark:text-blue-200">
                                    Kelola data Anda dengan lebih efisien. Fitur
                                    pencarian, pelaporan, dan visualisasi data
                                    yang akurat.
                                </p>
                            </div>
                        </div>
                ...
                <footer className="pt-[2remx`] sm:pt-[8rem] text-center lg:text-lg font-bold text-blue-950 dark:text-white/70">
                    Develop By{" "}
                    <a
