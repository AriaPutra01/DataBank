    ...
    return (
        <GuestLayout>
            ...
            <form onSubmit={submit}>
                ...
                <div className="mt-4">
                    <InputLabel className="font-extrabold" htmlFor="email" value="Email" />
                ...
                <div className="mt-4">
                    <InputLabel className="font-extrabold" htmlFor="password" value="Password" />
                ...
                <div className="mt-4">
                    <InputLabel className="font-extrabold" htmlFor="usertype" value="User Type" />
                    <select
                        id="usertype"
                        name="usertype"
                        value={data.usertype}
