        ...
        >
            ...
            <div className="py-12">
                <div className="lg:max-w-[75vw] mx-auto sm:px-6 lg:px-8">
                    <div className="p-6 bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg transition-all">
                        <h1 className="sm:text-2xl font-bold mb-8 p-2 text-center dark:text-white bg-gray-100 dark:bg-gray-700 w-full rounded-md transition-all">
                            List Permohonan Pendaftaran Akun
                        </h1>
                        <table className="border-b-2 border-gray-200 dark:border-gray-600 w-full text-gray-800 dark:text-white transition-all">
